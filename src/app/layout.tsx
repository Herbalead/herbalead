      ...
      <head>
        ...
        <style dangerouslySetInnerHTML={{
          __html: `
            ...
            .bg-gradient-to-br { background: linear-gradient(to bottom right, #f0fdf4, #dcfce7) !important; }
            ...
            .bg-gradient-to-r { background: linear-gradient(to right, #059669, #16a34a) !important; }
