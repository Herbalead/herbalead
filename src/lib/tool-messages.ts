export const toolMessages = {
  'imc': {
    ...
    image: 'https://www.herbalead.com/og-images/imc-og-image.jpg'
  },
  'proteina': {
    ...
    image: 'https://www.herbalead.com/og-images/proteina-og-image.jpg'
  },
  'hidratacao': {
    ...
    image: 'https://www.herbalead.com/og-images/hidratacao-og-image.jpg'
  },
  'nutricao': {
    ...
    image: 'https://www.herbalead.com/og-images/nutricao-og-image.jpg'
  },
  'bmi': {
    title: 'Calculadora de IMC Profissional',
    description: 'Calcule seu Índice de Massa Corporal com nossa calculadora especializada e receba orientações personalizadas.',
...
export const getToolMessage = (toolName: string) => {
  return toolMessages[toolName as keyof typeof toolMessages] || {
    ...
    image: 'https://www.herbalead.com/og-images/herbalead-main-og-image.jpg'
  }
}
