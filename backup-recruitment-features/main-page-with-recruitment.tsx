...
export default function HerbaleadLandingPage() {
  ...
  const handleDemoClick = (demoType: string) => {
    ...
    switch(demoType) {
      ...
      case 'recruitment-ganhos':
        router.push('/quiz/ganhos')
        break
      case 'recruitment-proposito':
        router.push('/quiz/proposito')
        break
      default:
        router.push('/demo/bmi')
    }
  ...
  const demos = [
    ...
    // 🌱 Ferramentas de Recrutamento (3 funcionalidades)
    {
      id: 'recruitment-potencial',
      title: 'Quiz: Potencial e Crescimento',
      description: 'Descubra se o potencial está sendo bem aproveitado',
      icon: TrendingUp,
      color: 'bg-emerald-500',
      category: 'Ferramentas de Recrutamento',
      tag: 'Demo disponível'
    },
    {
      id: 'recruitment-ganhos',
      title: 'Quiz: Ganhos e Prosperidade',
    ...
    },
    {
      ...
      title: 'Quiz: Propósito e Equilíbrio',
