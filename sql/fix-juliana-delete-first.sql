-- CORREÇÃO DEFINITIVA DA JULIANA - REMOVER REFERÊNCIA PRIMEIRO
...
-- 3. PRIMEIRO: Deletar assinatura existente (remove referência)
DELETE FROM subscriptions 
WHERE user_id = 'f83d995a-c9c5-4988-90ad-2396afc1a099';

-- 4. SEGUNDO: Deletar pagamentos relacionados (se existirem)
DELETE FROM payments 
WHERE subscription_id IN (
    SELECT id FROM subscriptions WHERE user_id = 'f83d995a-c9c5-4988-90ad-2396afc1a099'
);

-- 5. TERCEIRO: Agora atualizar o profissional (sem referência)
UPDATE professionals 
SET id = 'af6ba68f-8e46-4c60-8e9d-3d3d56652c59'
WHERE email = 'julianazr94@gmail.com';

-- 6. QUARTO: Atualizar dados do profissional
UPDATE professionals 
SET 
...
-- 7. QUINTO: Criar nova assinatura
