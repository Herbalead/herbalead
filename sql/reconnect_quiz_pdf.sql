-- Script para reconectar PDF ao módulo "Como criar quiz personalizado"
-- Execute este script no SQL Editor do Supabase

-- 1. Verificar o módulo atual
SELECT 
  'Módulo atual:' as status,
  id,
  title,
  description,
  pdf_files,
...
-- 2. Atualizar o módulo com o PDF correto
