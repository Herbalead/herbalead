-- Script corrigido para gerenciar administradores do sistema
...
-- 5. Criar função para listar administradores (CORRIGIDA)
...
-- 6. Corrigir inserção de categorias de materiais (sem ON CONFLICT)
...
-- 7. Exemplo de uso - Tornar um usuário administrador
...
-- 8. Listar todos os administradores atuais
SELECT * FROM list_admins();

-- 9. Verificar usuários ativos
SELECT 
    id,
    name,
    email,
...
-- 10. Criar política RLS para administradores
...
-- 11. Verificar se as políticas estão ativas
